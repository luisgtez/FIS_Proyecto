...
VALUES
    (1, '2023-01-20', 1.5, 'Parque Central', 5.2, 180, 120, 'Natacion', 1),
    (2, '2023-02-05', 2.0, 'Gimnasio FitLife', 6.2, 160, 100, 'Carrera', 2),
    (3, '2023-03-15', 1.0, 'Pista de atletismo', 10.0, 190, 130, 'Carrera', 3),
    (4, '2023-04-10', 1.5, 'Paseo Marítimo', 7.8, 175, 115, 'Natacion', 4),
    (5, '2023-05-02', 2.5, 'Bosque Nacional', 12.3, 195, 140, 'Natacion', 5),
    (6, '2023-01-25', 1.0, 'Piscina Municipal', 2.3, 160, 100, 'Natacion', 1),
    ...
    (10, '2023-02-15', 1.5, 'Pista de atletismo', 8.0, 175, 120, 'Natacion', 2),
    (11, '2023-06-05', 2.0, 'Paseo Marítimo', 8.7, 180, 125, 'Carrera', 6),
    (12, '2023-07-20', 1.0, 'Parque Central', 5.0, 170, 120, 'Carrera', 6),
    (13, '2023-08-10', 2.5, 'Bosque Nacional', 11.0, 185, 130, 'Natacion', 6),
    (14, '2023-09-15', 1.5, 'Pista de atletismo', 9.0, 175, 120, 'Carrera', 6),
    (15, '2023-10-05', 3.0, 'Gimnasio FitLife', 10, 165, 110, 'Natacion', 6);
